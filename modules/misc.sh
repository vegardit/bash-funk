    ...
    for __arg in "$@"; do
        case $__arg in
            ...
            --selftest)
                ...
                if [[ ! "$__stdout" =~ $__regex ]]; then echo -e "--> [31mFAILED[0m - stdout [$__stdout] does not match required pattern [Bash variable 'USER' exists.]."; return 64; fi
                echo "--> [32mOK[0m"
                echo -e "$ \033[1m$__fn -v NON_EXISTANT_VARIABLE\033[22m"
                ...
                if [[ ! "$__stdout" =~ $__regex ]]; then echo -e "--> [31mFAILED[0m - stdout [$__stdout] does not match required pattern [Bash variable 'NON_EXISTANT_VARIABLE' does not exist.]."; return 64; fi
                echo "--> [32mOK[0m"
                echo "Testing function [$__fn]...DONE"
                return 0
              ;;
