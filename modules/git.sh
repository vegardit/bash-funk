...
__BASH_FUNK_FUNCS+=( git-branch-name git-create-empty-branch git-modified-files git-switch-remote-protocol git-sync-fork git-update-branch github-upstream-url test-git )
