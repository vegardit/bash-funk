...
function -ascii2hex() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: ${FUNCNAME[0]} [OPTION]... ASCII_STRING"
                echo 
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} XYZ\e[22m"
                echo "58595A"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} XYZ\e[22m"
                stdout=$(${FUNCNAME[0]} XYZ); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^58595A$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [58595A]."; return 1; fi
                echo "--> OK"
    ...
    if [[ $_ASCII_STRING ]]; then
        ...
        echo "Error: Parameter ASCII_STRING must be specified."; return 1
    fi
...
function -hex2ascii() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: ${FUNCNAME[0]} [OPTION]... HEX_STRING"
                echo 
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} 58595A\e[22m"
                echo "XYZ"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} 58595A\e[22m"
                stdout=$(${FUNCNAME[0]} 58595A); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^XYZ$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [XYZ]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    if [[ $_HEX_STRING ]]; then
        ...
        echo "Error: Parameter HEX_STRING must be specified."; return 1
    fi
...
function -normalize-path() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} a/./b/c/d/../e\e[22m"
                echo "a/b/c/e"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} a/./b/c/d/../e\e[22m"
                stdout=$(${FUNCNAME[0]} a/./b/c/d/../e); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^a/b/c/e$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [a/b/c/e]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    if [[ $_PATH ]]; then
        ...
        echo "Error: Parameter PATH must be specified."; return 1
    fi
...
function -str-join() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: ${FUNCNAME[0]} [OPTION]... SEPARATOR [STRING]..."
                echo 
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} , a b c\e[22m"
                echo "a,b,c"
                echo -e "$ \e[1m${FUNCNAME[0]} , a \e[22m"
                echo "a"
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} , a b c\e[22m"
                stdout=$(${FUNCNAME[0]} , a b c); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^a,b,c$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [a,b,c]."; return 1; fi
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} , a \e[22m"
                stdout=$(${FUNCNAME[0]} , a ); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^a$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [a]."; return 1; fi
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} , \e[22m"
    ...
    if [[ $_SEPARATOR ]]; then
        ...
        echo "Error: Parameter SEPARATOR must be specified."; return 1
    fi
    if [[ _STRING ]]; then
        true
    fi
...
function -str-lower() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} aBcDeF\e[22m"
                echo "abcdef"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} aBcDeF\e[22m"
                stdout=$(${FUNCNAME[0]} aBcDeF); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^abcdef$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [abcdef]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    if [[ $_STRING ]]; then
        ...
        echo "Error: Parameter STRING must be specified."; return 1
    fi
...
function -str-matches() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: ${FUNCNAME[0]} [OPTION]... REGEX_PATTERN [STRING]..."
                echo 
                ...
                echo -e "$ \e[1m${FUNCNAME[0]} A\e[22m"
                echo 
                echo -e "$ \e[1m${FUNCNAME[0]} A A B\e[22m"
                echo "A"
                echo -e "$ \e[1m${FUNCNAME[0]} -v A A B\e[22m"
                echo "match: A
no match: B"
                echo -e "$ \e[1m${FUNCNAME[0]} -a A A B\e[22m"
                echo "A"
                echo -e "$ \e[1m${FUNCNAME[0]} -v -a A A B\e[22m"
                echo "match: A
no match: B"
                echo 
                return 0
...
no match: B]."; return 1; fi
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} -v -a A A B\e[22m"
                stdout=$(${FUNCNAME[0]} -v -a A A B); rc=$?
                echo $stdout
                if [[ $rc != 1 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [1]."; return 1; fi
                regex="^match: A
no match: B$"
...
no match: B]."; return 1; fi
    ...
    if [[ $_REGEX_PATTERN ]]; then
        ...
        echo "Error: Parameter REGEX_PATTERN must be specified."; return 1
    fi
    if [[ _STRING ]]; then
        true
    fi
...
function -str-repeat() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: ${FUNCNAME[0]} [OPTION]... STRING COUNT"
                echo 
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} a 3\e[22m"
                echo "aaa"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} a 3\e[22m"
                stdout=$(${FUNCNAME[0]} a 3); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^aaa$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [aaa]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    if [[ $_COUNT ]]; then
        local regex="^[1-9]\d*$"
        if [[ ! "$_COUNT" =~ $regex ]]; then echo "Error: Value '$_COUNT' for parameter COUNT must be a number > 0"; return 1; fi
        unset regex
        true
    else
        echo "Error: Parameter COUNT must be specified."; return 1
    fi
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} \"  abc  \"\e[22m"
                echo "abc"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} "  abc  "\e[22m"
                stdout=$(${FUNCNAME[0]} "  abc  "); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^abc$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [abc]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} $(echo -e '\e[4mThis is underlined\e[24m')\e[22m"
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} $(echo -e '\e[4mThis is underlined\e[24m')\e[22m"
                stdout=$(${FUNCNAME[0]} $(echo -e '\e[4mThis is underlined\e[24m')); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^This is underlined$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [This is underlined]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
...
function -substr-after() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: ${FUNCNAME[0]} [OPTION]... SEARCH_IN SEARCH_FOR"
                echo 
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} 00aa11aa22 aa\e[22m"
                echo "11aa22"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} 00aa11aa22 aa\e[22m"
                stdout=$(${FUNCNAME[0]} 00aa11aa22 aa); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^11aa22$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [11aa22]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    if [[ $_SEARCH_IN ]]; then
        ...
        echo "Error: Parameter SEARCH_IN must be specified."; return 1
    fi
    if [[ $_SEARCH_FOR ]]; then
        true
    else
        echo "Error: Parameter SEARCH_FOR must be specified."; return 1
    fi
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --selftest)
                ...
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^22$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [22]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --selftest)
                ...
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^00$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [00]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} 00aa11aa00 aa\e[22m"
                echo "00aa11"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} 00aa11aa00 aa\e[22m"
                stdout=$(${FUNCNAME[0]} 00aa11aa00 aa); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^00aa11$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [00aa11]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
...
function -substr-between() {
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: ${FUNCNAME[0]} [OPTION]... SEARCH_IN PREFIX SUFFIX"
                echo 
                ...
                echo 
                echo "Examples:"
                echo -e "$ \e[1m${FUNCNAME[0]} 00aa11aa22aa00 aa aa\e[22m"
                echo "11"
                echo 
                return 0
              ;;
            ...
            --selftest)
                ...
                echo "--> OK"
                echo -e "$ \e[1m${FUNCNAME[0]} 00aa11aa22aa00 aa aa\e[22m"
                stdout=$(${FUNCNAME[0]} 00aa11aa22aa00 aa aa); rc=$?
                echo $stdout
                if [[ $rc != 0 ]]; then echo "--> FAILED - exit code [$rc] instead of expected [0]."; return 1; fi
                regex="^11$"
                if [[ ! "$stdout" =~ $regex ]]; then echo "--> FAILED - stdout [$stdout] does not match required pattern [11]."; return 1; fi
                echo "--> OK"
                echo "Testing function [${FUNCNAME[0]}]...DONE"
                return 0
              ;;
    ...
    if [[ $_PREFIX ]]; then
        ...
        echo "Error: Parameter PREFIX must be specified."; return 1
    fi
    if [[ $_SUFFIX ]]; then
        true
    else
        echo "Error: Parameter SUFFIX must be specified."; return 1
    fi
