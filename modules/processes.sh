...
Type '$fn --help' for more details."
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: $fn [OPTION]... [PARENT_PID]"
                echo 
...
Type '$fn --help' for more details."
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: $fn [OPTION]... [CHILD_PID]"
                echo 
...
Usage: $fn [OPTION]... SIGNAL [PARENT_PID]
...
Type '$fn --help' for more details."
    ...
    for arg in "$@"; do
        case $arg in
            ...
            --help)
                echo "Usage: $fn [OPTION]... SIGNAL [PARENT_PID]"
                echo 
